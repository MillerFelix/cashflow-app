...
export function useDashboardMetrics(transactions, userProfile) {
  ...
  const currentMonthYear = todayStr.substring(0, 7); // Ex: "2024-10"
  ...
  const daysUntilPayday = useMemo(() => {
    ...
    return minDays;
  }, [userProfile.payDay, userProfile.payDay2]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  }, [totalMonthIncome, totalMonthExpenseSoFar, userProfile.financialFocus]); // eslint-disable-line react-hooks/exhaustive-deps
