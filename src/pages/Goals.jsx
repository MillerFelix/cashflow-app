...
import { useGoalsMetrics } from "../hooks/useGoalsMetrics";
import {
  FaHeartbeat,
  FaShieldAlt,
  FaBullseye,
...
function Goals() {
  ...
  const {
    ...
    lifeGoals,
    formatCurrency,
  } = useGoalsMetrics(transactions, goals);
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2 border-b border-gray-200 pb-2 mt-4">
            <FaChartPie className="text-blue-500" /> Orçamento Mensal
          </h2>
          {budgets.length === 0 ? (
        ...
        {/* PILAR 4: OBJETIVOS DE VIDA */}
        <div className="flex flex-col gap-4 mb-8">
          <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2 border-b border-gray-200 pb-2 mt-4">
            <FaBullseye className="text-purple-500" /> Objetivos de Vida
          </h2>
          {lifeGoals.length === 0 ? (
            <div className="bg-white p-8 rounded-2xl border border-dashed border-gray-300 text-center">
              <p className="text-gray-400 text-sm">
